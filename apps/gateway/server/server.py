...
</div><div class="modal" id="modal"><div class="sheet"><div class="sheet-heading"><div class="sheet-heading-copy"><h3 id="modalTitle"></h3><p id="modalBody"></p></div></div><div id="directoryToolbar" class="directory-toolbar" hidden><nav id="directoryBreadcrumb" class="directory-breadcrumb" aria-label="Current folder"></nav><div class="directory-filter-row"><label class="directory-search"><span class="visually-hidden">Filter folders</span><span aria-hidden="true">⌕</span><input id="directorySearch" type="search" inputmode="search" autocomplete="off" spellcheck="false" placeholder="Filter folders"></label><button id="directoryHiddenToggle" class="directory-hidden-toggle" type="button" aria-pressed="false"><span aria-hidden="true">.</span> Hidden</button></div></div><div class="choice-list" id="modalChoices"></div><div class="modal-actions" id="modalActions"></div></div></div><script id="faryoRouteLabels" type="application/json" nonce="{CSP_NONCE_PLACEHOLDER}">{labels_json}</script><script src="/workbench-preact.js?v=faryo-gateway-preact-1"></script><script src="/workbench.js?v=faryo-gateway-3"></script></body></html>'''
