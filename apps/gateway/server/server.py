...
</div><div class="modal" id="modal"><div class="sheet"><div class="sheet-heading"><div class="sheet-heading-copy"><h3 id="modalTitle"></h3><p id="modalBody"></p></div></div><div id="directoryToolbar" class="directory-toolbar" hidden><nav id="directoryBreadcrumb" class="directory-breadcrumb" aria-label="Current folder"></nav><div class="directory-filter-row"><label class="directory-search"><span class="visually-hidden">Filter folders</span><span aria-hidden="true">⌕</span><input id="directorySearch" type="search" inputmode="search" autocomplete="off" spellcheck="false" placeholder="Filter folders"></label><button id="directoryHiddenToggle" class="directory-hidden-toggle" type="button" aria-pressed="false"><span aria-hidden="true">.</span> Hidden</button></div><fieldset id="contextWindowPicker" class="context-window-picker"><legend>Context window</legend><div class="context-window-controls"><button type="button" data-context-window-k="0" aria-pressed="true">Default</button><button type="button" data-context-window-k="272" aria-pressed="false">272K</button><button type="button" data-context-window-k="1000" aria-pressed="false">1M</button><label class="context-window-custom"><span class="visually-hidden">Custom context window in K tokens</span><input id="contextWindowCustom" type="number" min="32" max="1050" step="1" inputmode="numeric" placeholder="Custom"><span>K</span></label></div><small id="contextWindowHelp">Inherit this workstation's Codex settings.</small><small id="contextWindowError" class="context-window-error" role="alert" hidden></small></fieldset></div><div class="choice-list" id="modalChoices"></div><div class="modal-actions" id="modalActions"></div></div></div><script id="faryoRouteLabels" type="application/json" nonce="{CSP_NONCE_PLACEHOLDER}">{labels_json}</script><script src="/workbench-preact.js?v={asset_version}"></script><script src="/workbench.js?v={asset_version}"></script></body></html>'''
