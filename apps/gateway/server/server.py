...
const WORKBENCH_CACHE_KEY='faryoWorkbenchSnapshot';const labels=__LABELS_JS__;let draggedPackage=null;let touchDrag=null;let assetTargetPackage=null;let actionBusy=false;let historyPage=1,historyTotalPages=1;
