...
export FARYO_CODEX_BIN_PINNED="${FARYO_CODEX_BIN_PINNED:-0}"
export FARYO_CODEX_AUTO_UPDATE="${FARYO_CODEX_AUTO_UPDATE:-1}"
...
ORDER = [
    ...
    "FARYO_PYTHON",
    "FARYO_CODEX_BIN",
    "FARYO_CODEX_BIN_PINNED",
    "FARYO_CODEX_AUTO_UPDATE",
    "FARYO_AGENT_SHELL",
...
values = {
    ...
    "FARYO_CODEX_BIN_PINNED": existing.get("FARYO_CODEX_BIN_PINNED") or os.environ["FARYO_CODEX_BIN_PINNED"],
    "FARYO_CODEX_AUTO_UPDATE": existing.get("FARYO_CODEX_AUTO_UPDATE") or os.environ["FARYO_CODEX_AUTO_UPDATE"],
