...
- Linux endpoint package: `faryo_1.1.1_all.deb`
- macOS endpoint package: `faryo_1.1.1_macos.tar.gz`
- Release page: https://github.com/Snailflyer/faryo/releases/tag/v1.1.1
...
```bash
curl -LO https://github.com/Snailflyer/faryo/releases/download/v1.1.1/faryo_1.1.1_all.deb
sudo dpkg -i faryo_1.1.1_all.deb
